...
void main()
{
    ...
    GLDisplay::GLDisplay(sutil::BufferImageFormat image_format)
        ...
        const uint32_t pbo) const
    {
        ...
        size_t elmt_size = sutil::pixelFormatSize(m_image_format);
        if (elmt_size % 8 == 0)
        ...
        if (m_image_format == sutil::BufferImageFormat::UNSIGNED_BYTE4)
        {
